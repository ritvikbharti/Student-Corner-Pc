...
export const metadata: Metadata = {
  title: "Student Help Corner | Find Your Dream College",
  description: "Explore thousands of colleges, courses, and scholarships to kickstart your career.",
};
  ...
  return (
    <html lang="en" className="h-full antialiased">
      <body className="min-h-full flex flex-col font-sans">
        ...
        <a 
          href="https://wa.me/919546369339?text=Hi%2C%20I%20need%20help%20with%20college%20admission."
          target="_blank"
          rel="noopener noreferrer"
          className="fixed bottom-6 right-6 z-50 bg-green-500 hover:bg-green-600 text-white rounded-full p-4 shadow-lg hover:shadow-xl transition flex items-center gap-2 group"
